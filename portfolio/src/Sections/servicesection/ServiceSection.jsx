...
const ServiceSection = () => {
  ...
  return (
    /* Changed font-['Inter'] to font-['Montserrat'] */
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <div 
              key={service.id} 
              className="bg-[#1c1c1c] p-8 rounded-3xl flex flex-col items-center text-center transition-transform duration-300 hover:-translate-y-2 border border-gray-800 hover:border-orange-500/50"
            >
